...
%	\end{figure*}
	...
	\begin{figure*}[!h]
		\centering
		\includegraphics[width=\textwidth,height=12pc]{figures/popc_ds}
...
\bmsection{Additional Results\label{app1}}
%\vspace*{12pt}
...
\begin{table*}[h]
	\caption{Design smell detection metrics.\label{table:metric}} % title of Table
	\centering % used for centering table
